...
class BaseProductDatabase {
  ...
  static async insertAll(batchOrIds, docsArg) {
    ...
    for (let doc of docs) {
      ...
      if (this.isFalse(doc?.blockedByHoliday)) {
        delete doc.blockedByHoliday
      }
      if (this.isFalse(doc?.is_multibuy)) {
        delete doc.is_multibuy
      }
      if (this.isFalse(doc?.isInCurrentLeaflet)) {
        delete doc.isInCurrentLeaflet
      }
      if (this.isFalse(doc?.pant)) {
        delete doc.pant
      }
      ...
      if (this.isFalse(doc?.nonsearchable)) {
        delete doc.nonsearchable
      }
      ...
      if (doc?.article && doc?.articleId && doc?.article === doc?.articleId) {
      ...
      if (doc?.price && doc?.unitOfMeasurePrice && doc?.price === doc?.unitOfMeasurePrice) {
        delete doc.unitOfMeasurePrice
      }
      ...
      if (Array.isArray(doc?.info)) {
        for (const entry of doc.info) {
